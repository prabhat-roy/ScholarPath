pipeline {
    ...
    stages {
        ...
        stage('Spectral + a11y')   { steps { sh 'cd api-testing/spectral && npm ci && npm run lint' } }
        stage('OpenSSF Scorecard') { steps { sh 'scorecard --repo=github.com/prabhat-roy/ScholarPath' } }
    }
}
