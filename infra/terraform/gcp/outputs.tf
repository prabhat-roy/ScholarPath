...
output "content_bucket"          { value = google_storage_bucket.content.name }
output "proctoring_bucket"       { value = google_storage_bucket.proctoring.name }
output "kms_key_ring"            { value = google_kms_key_ring.scholarpath.id }
