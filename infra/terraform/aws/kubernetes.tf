module "eks" {
  ...
  eks_managed_node_groups = {
    ...
    # Live virtual classroom + AI proctoring run on GPU nodes for low-latency inference.
    gpu = {
      ...
      taints = [{ key = "scholarpath.io/workload", value = "live-classroom", effect = "NO_SCHEDULE" }]
    }
  }
